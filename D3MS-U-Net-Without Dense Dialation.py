...
class D3MSU_wDD(nn.Module):
    def __init__(self,input_channels):
        super(D3MSU_wDD,self).__init__()
        self.encoder=ResNet(1,BasicBlock,[3,3,3,3])
        self.bn_conv0=bn_conv2(512,512,1)

        self.decoder1=decoder(1024,8,1)
        self.decoder2=decoder(512,4,1)
        self.decoder3=decoder(256,2,1)
